...
object Prefs {
    ...
    /**
     * Where on the ladder the taper begins. 1 = ease in with reminders only;
     * 3 = pause screen from day one; 6 = windows straight away.
     */
    var Context.startWeek: Int
        get() = sp(this).getInt("startWeek", 1)
        set(v) = sp(this).edit().putInt("startWeek", v).apply()
